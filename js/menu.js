            ...
            <div class="card h-100 shadow-sm border-0" style="background-color: var(--secondary-color);">
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <span class="badge" style="background-color: var(--primary-color); color: var(--secondary-color); font-size: 0.9em;">$${parseFloat(item.price).toFixed(2)}</span>
                    </div>
                    <p class="card-text small flex-grow-1" style="color: #555;">${item.description || ''}</p>
                    <button class="btn w-100 fw-bold mt-3" style="background-color: var(--primary-color); color: var(--secondary-color);" data-id="${item.id}" onclick="addToCart(${item.id})">
                        Add to Cart
                    </button>
                </div>
            </div>
...
// Stub for add to cart functionality (to be implemented later in cart.js)
